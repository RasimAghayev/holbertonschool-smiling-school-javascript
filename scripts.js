              ...
              <div class="row">
                <div class="col">
                  <img class="rounded-circle" src=${
                    response[i].pic_url
                  } class="d-block" alt="" width="160" height="160">
                </div>
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      for (let i = 0; i < response.length; i++) {
        let $card_stars = "";
        let $play_button =
          '<img src="images/play.png" class="play-btn1" alt="..."   width="64" height="64">';
        for (let j = 0; j < response[i].star; j++) {
          $card_stars +=
            '<img src="images/star_on.png" class=" star-size mr-1" alt="..." width="15" height="15">';
        }
        for (let j = 0; j < 5 - response[i].star; j++) {
          $card_stars +=
            '<img src="images/star_off.png" class=" star-size" alt="..." width="15" height="15">';
        }
        let $html = $(`
              <div class="text-center col-12 col-sm-6 col-md-3">
                <div class="carousel-item active">
